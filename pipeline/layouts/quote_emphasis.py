...
class QuoteEmphasisLayout:
    ...
    def build_html(
        ...
        return (
            ...
            '\n'
            f'<div style="position:absolute; left:53px; top:101px; width:1173px; height:144px; '
            f'background-color:{bg};">\n'
            f'  <div style="position:absolute; left:0; top:0; width:6px; height:144px; '
            f'background-color:{accent};"></div>\n'
            f'  <p style="position:absolute; left:27px; top:21px; width:1125px; '
